...
DOCUMENTATION:
  ...
  description:
    ...
    - Follows symlinks and checks the target of the symlink instead of the link itself, use the P(ansible.builtin.link#test) or
      P(ansible.builtin.link_exists#test) tests to check on the link.
  options:
    _input:
      description: a path
      type: path
