...
DOCUMENTATION:
  ...
  notes:
    - For a full list of format codes for working with Python date format strings, see L(the Python documentation,
      https://docs.python.org/3/library/datetime.html#strftime-and-strptime-behavior).
    - The timedelta object produced by the difference of two datetimes store the days, seconds, and microseconds of the delta. This results in the C(seconds)
      attribute being the total seconds of the minutes and hours of that delta. See L(datatime.timedelta,
      https://docs.python.org/3/library/datetime.html#timedelta-objects) for more information about how a timedelta works.
  positional: _input
  options:
    _input:
