...
- key: namespace
  description:
    ...
    - May only contain alphanumeric lowercase characters and underscores. Namespaces cannot start with underscores or numbers and cannot contain consecutive
      underscores.
  required: yes
  type: str
...
- key: dependencies
  description:
    ...
    - The value is a version range L(specifiers,https://python-semanticversion.readthedocs.io/en/latest/#requirement-specification).
...
- key: build_ignore
  description:
    ...
    - Some directories and files like C(galaxy.yml), C(*.pyc), C(*.retry), and C(.git) are always filtered.
